...
public class GridCacheTestEntryEx<K, V> extends GridMetadataAwareAdapter implements GridCacheEntryEx<K, V> {
    ...
    @Override public GridBiTuple<Boolean, V> innerUpdateLocal(GridCacheVersion ver, GridCacheOperation op,
        ...
        @Nullable GridPredicate<GridCacheEntry<K, V>>[] filter, boolean intercept)
    ...
    @Override public GridCacheUpdateAtomicResult<K, V> innerUpdate(
        ...
        boolean intercept) throws GridException,
        GridCacheEntryRemovedException {
    ...
    /** @inheritDoc */
    @Override public V peek(GridCachePeekMode mode, GridPredicate<GridCacheEntry<K, V>>[] filter) {
        return val;
    }

    /** @inheritDoc */
    @Override public GridTuple<V> peek0(boolean failFast, GridCachePeekMode mode,
        GridPredicate<GridCacheEntry<K, V>>[] filter, GridCacheTxEx<K, V> tx)
