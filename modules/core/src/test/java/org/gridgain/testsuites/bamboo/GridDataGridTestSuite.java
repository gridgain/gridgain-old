...
//        suite.addTestSuite(GridCacheP2PUndeploySelfTest.class); TODO uncomment in DR branch.
        ...
        suite.addTestSuite(GridCachePartitionedLockBackupUpdateSelfTest.class);
        suite.addTestSuite(ClientAffinityAssignmentSelfTest.class);
...
//        suite.addTest(new TestSuite(GridCachePartitionedTopologyChangeSelfTest.class)); TODO-gg-5489
        ...
        suite.addTest(new TestSuite(GridCacheDataLostEventSelfTest.class));
...
//        suite.addTest(new TestSuite(GridCacheNearRemoveFailureTest.class));
        ...
        suite.addTestSuite(GridMultiTxLockSelfTest.class);
